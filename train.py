...
if __name__ == "__main__":
    ...
    #                   Windows系统下默认使用DP模式调用所有显卡，不支持DDP。w
    #   DP模式：
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path      = "logs_3/last_epoch_weights.pth"
    #---------------------------------------------------------#
    ...
    #------------------------------------------------------------------#
    cls_weights     = np.array([1,3,1,2], np.float32)
    #------------------------------------------------------------------#
    ...
    if local_rank == 0:
        ...
        log_dir         = os.path.join(save_dir, "loss_" + str(time_str))   #log_dir保存在log文件夹
